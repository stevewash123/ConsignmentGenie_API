...
; // TODO: Optimize image loading - removed Include to fix EF query type conflicts
            ...
            {
                query = query.Where(i => i.ItemCategoryNavigation != null && i.ItemCategoryNavigation.Name == category);
            }
...
; // TODO: Optimize image loading - removed Include to fix EF query type conflicts
            ...
            foreach (var term in searchTerms)
            {
                query = query.Where(i =>
                    ...
                    (i.ItemCategoryNavigation != null && i.ItemCategoryNavigation.Name.ToLower().Contains(term)));
            }
