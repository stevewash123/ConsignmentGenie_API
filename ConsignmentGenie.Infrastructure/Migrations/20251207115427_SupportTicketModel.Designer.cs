...
namespace ConsignmentGenie.Infrastructure.Migrations
{
    ...
    [Migration("20251207115427_SupportTicketModel")]
    partial class SupportTicketModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.Consignor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 12, 7, 11, 54, 25, 571, DateTimeKind.Utc).AddTicks(6102),
                            ...
                            PortalAccess = false,
                            Status = 1,
                            UpdatedAt = new DateTime(2025, 12, 7, 11, 54, 25, 571, DateTimeKind.Utc).AddTicks(6103),
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.Organization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 12, 7, 11, 54, 24, 983, DateTimeKind.Utc).AddTicks(905),
                            Currency = "USD",
                            ...
                            UpdatedAt = new DateTime(2025, 12, 7, 11, 54, 24, 983, DateTimeKind.Utc).AddTicks(908),
                            VerticalType = 1,
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2025, 12, 7, 11, 54, 25, 571, DateTimeKind.Utc).AddTicks(5807),
                            Email = "admin@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$QbSCoa4g4g1hPkZNUrD08ef0EEGb0LafwKVPlvqcRKxEYQeZ/lTli",
                            Role = 1,
                            UpdatedAt = new DateTime(2025, 12, 7, 11, 54, 25, 571, DateTimeKind.Utc).AddTicks(5845)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2025, 12, 7, 11, 54, 25, 571, DateTimeKind.Utc).AddTicks(5877),
                            Email = "owner1@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$QbSCoa4g4g1hPkZNUrD08ef0EEGb0LafwKVPlvqcRKxEYQeZ/lTli",
                            Role = 1,
                            UpdatedAt = new DateTime(2025, 12, 7, 11, 54, 25, 571, DateTimeKind.Utc).AddTicks(5877)
                        },
                        new
                        {
                            Id = new Guid("44444444-4444-4444-4444-444444444444"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2025, 12, 7, 11, 54, 25, 571, DateTimeKind.Utc).AddTicks(5895),
                            Email = "provider1@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$QbSCoa4g4g1hPkZNUrD08ef0EEGb0LafwKVPlvqcRKxEYQeZ/lTli",
                            Role = 2,
                            UpdatedAt = new DateTime(2025, 12, 7, 11, 54, 25, 571, DateTimeKind.Utc).AddTicks(5895)
                        },
                        new
                        {
                            Id = new Guid("55555555-5555-5555-5555-555555555555"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2025, 12, 7, 11, 54, 25, 571, DateTimeKind.Utc).AddTicks(5913),
                            Email = "customer1@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$QbSCoa4g4g1hPkZNUrD08ef0EEGb0LafwKVPlvqcRKxEYQeZ/lTli",
                            Role = 3,
                            UpdatedAt = new DateTime(2025, 12, 7, 11, 54, 25, 571, DateTimeKind.Utc).AddTicks(5913)
                        });
                });
