...
namespace ConsignmentGenie.Infrastructure.Migrations
{
    ...
    [Migration("20260204043536_RemoveObsoleteAgreementTemplateId")]
    partial class RemoveObsoleteAgreementTemplateId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.Consignor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 2, 4, 4, 35, 34, 516, DateTimeKind.Utc).AddTicks(938),
                            ...
                            PortalAccess = false,
                            Status = 1,
                            UpdatedAt = new DateTime(2026, 2, 4, 4, 35, 34, 516, DateTimeKind.Utc).AddTicks(938),
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.Organization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 2, 4, 4, 35, 33, 951, DateTimeKind.Utc).AddTicks(2480),
                            Currency = "USD",
                            ...
                            Subdomain = "demo-shop",
                            TaxRate = 0.0000m,
                            UpdatedAt = new DateTime(2026, 2, 4, 4, 35, 33, 951, DateTimeKind.Utc).AddTicks(2482),
                            VerticalType = 1,
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2026, 2, 4, 4, 35, 34, 516, DateTimeKind.Utc).AddTicks(651),
                            Email = "admin@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$YRCBRRH6MSKhysX8HOp7NudvMU25HfLCP4u8O1RWr2/ikcjXUEmJu",
                            Role = 1,
                            UpdatedAt = new DateTime(2026, 2, 4, 4, 35, 34, 516, DateTimeKind.Utc).AddTicks(696)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2026, 2, 4, 4, 35, 34, 516, DateTimeKind.Utc).AddTicks(724),
                            Email = "owner1@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$YRCBRRH6MSKhysX8HOp7NudvMU25HfLCP4u8O1RWr2/ikcjXUEmJu",
                            Role = 1,
                            UpdatedAt = new DateTime(2026, 2, 4, 4, 35, 34, 516, DateTimeKind.Utc).AddTicks(725)
                        },
                        new
                        {
                            Id = new Guid("44444444-4444-4444-4444-444444444444"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2026, 2, 4, 4, 35, 34, 516, DateTimeKind.Utc).AddTicks(740),
                            Email = "consignor1@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$YRCBRRH6MSKhysX8HOp7NudvMU25HfLCP4u8O1RWr2/ikcjXUEmJu",
                            Role = 2,
                            UpdatedAt = new DateTime(2026, 2, 4, 4, 35, 34, 516, DateTimeKind.Utc).AddTicks(740)
                        },
                        new
                        {
                            Id = new Guid("55555555-5555-5555-5555-555555555555"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2026, 2, 4, 4, 35, 34, 516, DateTimeKind.Utc).AddTicks(758),
                            Email = "customer1@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$YRCBRRH6MSKhysX8HOp7NudvMU25HfLCP4u8O1RWr2/ikcjXUEmJu",
                            Role = 3,
                            UpdatedAt = new DateTime(2026, 2, 4, 4, 35, 34, 516, DateTimeKind.Utc).AddTicks(759)
                        });
                });
