...
namespace ConsignmentGenie.Infrastructure.Migrations
{
    ...
    [Migration("20260205210349_IncreaseImageUrlLength")]
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.Consignor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 2, 5, 21, 3, 47, 898, DateTimeKind.Utc).AddTicks(8232),
                            ...
                            PortalAccess = false,
                            Status = 1,
                            UpdatedAt = new DateTime(2026, 2, 5, 21, 3, 47, 898, DateTimeKind.Utc).AddTicks(8233),
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.Organization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 2, 5, 21, 3, 47, 334, DateTimeKind.Utc).AddTicks(5542),
                            Currency = "USD",
                            ...
                            Subdomain = "demo-shop",
                            TaxRate = 0.0000m,
                            UpdatedAt = new DateTime(2026, 2, 5, 21, 3, 47, 334, DateTimeKind.Utc).AddTicks(5543),
                            VerticalType = 1,
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2026, 2, 5, 21, 3, 47, 898, DateTimeKind.Utc).AddTicks(7955),
                            Email = "admin@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$S6QX48tK7gxmHCuN7.vX6OCtKBWmvCqW3m6qYqQw4joULlxJk1PGC",
                            Role = 1,
                            UpdatedAt = new DateTime(2026, 2, 5, 21, 3, 47, 898, DateTimeKind.Utc).AddTicks(7994)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2026, 2, 5, 21, 3, 47, 898, DateTimeKind.Utc).AddTicks(8025),
                            Email = "owner1@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$S6QX48tK7gxmHCuN7.vX6OCtKBWmvCqW3m6qYqQw4joULlxJk1PGC",
                            Role = 1,
                            UpdatedAt = new DateTime(2026, 2, 5, 21, 3, 47, 898, DateTimeKind.Utc).AddTicks(8026)
                        },
                        new
                        {
                            Id = new Guid("44444444-4444-4444-4444-444444444444"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2026, 2, 5, 21, 3, 47, 898, DateTimeKind.Utc).AddTicks(8043),
                            Email = "consignor1@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$S6QX48tK7gxmHCuN7.vX6OCtKBWmvCqW3m6qYqQw4joULlxJk1PGC",
                            Role = 2,
                            UpdatedAt = new DateTime(2026, 2, 5, 21, 3, 47, 898, DateTimeKind.Utc).AddTicks(8044)
                        },
                        new
                        {
                            Id = new Guid("55555555-5555-5555-5555-555555555555"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2026, 2, 5, 21, 3, 47, 898, DateTimeKind.Utc).AddTicks(8059),
                            Email = "customer1@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$S6QX48tK7gxmHCuN7.vX6OCtKBWmvCqW3m6qYqQw4joULlxJk1PGC",
                            Role = 3,
                            UpdatedAt = new DateTime(2026, 2, 5, 21, 3, 47, 898, DateTimeKind.Utc).AddTicks(8059)
                        });
                });
