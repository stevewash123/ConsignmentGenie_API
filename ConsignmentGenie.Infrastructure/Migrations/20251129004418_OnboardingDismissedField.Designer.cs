...
namespace ConsignmentGenie.Infrastructure.Migrations
{
    ...
    [Migration("20251129004418_OnboardingDismissedField")]
    partial class OnboardingDismissedField
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.Organization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 29, 0, 44, 15, 813, DateTimeKind.Utc).AddTicks(9594),
                            Currency = "USD",
                            ...
                            UpdatedAt = new DateTime(2025, 11, 29, 0, 44, 15, 813, DateTimeKind.Utc).AddTicks(9595),
                            VerticalType = 1
                        });
                });
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.Provider", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 29, 0, 44, 16, 401, DateTimeKind.Utc).AddTicks(6583),
                            ...
                            Status = 1,
                            UpdatedAt = new DateTime(2025, 11, 29, 0, 44, 16, 401, DateTimeKind.Utc).AddTicks(6585),
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2025, 11, 29, 0, 44, 16, 401, DateTimeKind.Utc).AddTicks(6265),
                            Email = "admin@microsaasbuilders.com",
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$eyMk393KPx9GY283.ONJ.u.mXdbdy0wff7.5IYHeplKcTIivsi62W",
                            Role = 1,
                            UpdatedAt = new DateTime(2025, 11, 29, 0, 44, 16, 401, DateTimeKind.Utc).AddTicks(6306)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2025, 11, 29, 0, 44, 16, 401, DateTimeKind.Utc).AddTicks(6334),
                            Email = "owner1@microsaasbuilders.com",
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$eyMk393KPx9GY283.ONJ.u.mXdbdy0wff7.5IYHeplKcTIivsi62W",
                            Role = 1,
                            UpdatedAt = new DateTime(2025, 11, 29, 0, 44, 16, 401, DateTimeKind.Utc).AddTicks(6334)
                        },
                        new
                        {
                            Id = new Guid("44444444-4444-4444-4444-444444444444"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2025, 11, 29, 0, 44, 16, 401, DateTimeKind.Utc).AddTicks(6349),
                            Email = "provider1@microsaasbuilders.com",
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$eyMk393KPx9GY283.ONJ.u.mXdbdy0wff7.5IYHeplKcTIivsi62W",
                            Role = 2,
                            UpdatedAt = new DateTime(2025, 11, 29, 0, 44, 16, 401, DateTimeKind.Utc).AddTicks(6350)
                        },
                        new
                        {
                            Id = new Guid("55555555-5555-5555-5555-555555555555"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2025, 11, 29, 0, 44, 16, 401, DateTimeKind.Utc).AddTicks(6367),
                            Email = "customer1@microsaasbuilders.com",
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$eyMk393KPx9GY283.ONJ.u.mXdbdy0wff7.5IYHeplKcTIivsi62W",
                            Role = 3,
                            UpdatedAt = new DateTime(2025, 11, 29, 0, 44, 16, 401, DateTimeKind.Utc).AddTicks(6367)
                        });
                });
