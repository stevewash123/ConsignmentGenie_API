...
namespace ConsignmentGenie.Infrastructure.Migrations
{
    ...
    [Migration("20260206005938_PendingConsolidatedNotifications")]
    partial class PendingConsolidatedNotifications
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.Consignor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 2, 6, 0, 59, 36, 39, DateTimeKind.Utc).AddTicks(6586),
                            ...
                            PortalAccess = false,
                            Status = 1,
                            UpdatedAt = new DateTime(2026, 2, 6, 0, 59, 36, 39, DateTimeKind.Utc).AddTicks(6587),
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.Organization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 2, 6, 0, 59, 35, 491, DateTimeKind.Utc).AddTicks(9357),
                            Currency = "USD",
                            ...
                            Subdomain = "demo-shop",
                            TaxRate = 0.0000m,
                            UpdatedAt = new DateTime(2026, 2, 6, 0, 59, 35, 491, DateTimeKind.Utc).AddTicks(9358),
                            VerticalType = 1,
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2026, 2, 6, 0, 59, 36, 39, DateTimeKind.Utc).AddTicks(6297),
                            Email = "admin@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$2IgW0ovHKDGE3yG9xPomOe9UOYy10w3KkciLaAD1RWMmQZH5opOfy",
                            Role = 1,
                            UpdatedAt = new DateTime(2026, 2, 6, 0, 59, 36, 39, DateTimeKind.Utc).AddTicks(6339)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2026, 2, 6, 0, 59, 36, 39, DateTimeKind.Utc).AddTicks(6369),
                            Email = "owner1@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$2IgW0ovHKDGE3yG9xPomOe9UOYy10w3KkciLaAD1RWMmQZH5opOfy",
                            Role = 1,
                            UpdatedAt = new DateTime(2026, 2, 6, 0, 59, 36, 39, DateTimeKind.Utc).AddTicks(6369)
                        },
                        new
                        {
                            Id = new Guid("44444444-4444-4444-4444-444444444444"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2026, 2, 6, 0, 59, 36, 39, DateTimeKind.Utc).AddTicks(6385),
                            Email = "consignor1@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$2IgW0ovHKDGE3yG9xPomOe9UOYy10w3KkciLaAD1RWMmQZH5opOfy",
                            Role = 2,
                            UpdatedAt = new DateTime(2026, 2, 6, 0, 59, 36, 39, DateTimeKind.Utc).AddTicks(6385)
                        },
                        new
                        {
                            Id = new Guid("55555555-5555-5555-5555-555555555555"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2026, 2, 6, 0, 59, 36, 39, DateTimeKind.Utc).AddTicks(6401),
                            Email = "customer1@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$2IgW0ovHKDGE3yG9xPomOe9UOYy10w3KkciLaAD1RWMmQZH5opOfy",
                            Role = 3,
                            UpdatedAt = new DateTime(2026, 2, 6, 0, 59, 36, 39, DateTimeKind.Utc).AddTicks(6401)
                        });
                });
