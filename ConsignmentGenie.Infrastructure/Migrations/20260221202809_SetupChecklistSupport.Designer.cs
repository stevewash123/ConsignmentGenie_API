...
namespace ConsignmentGenie.Infrastructure.Migrations
{
    ...
    [Migration("20260221202809_SetupChecklistSupport")]
    partial class SetupChecklistSupport
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.Consignor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 2, 21, 20, 28, 8, 374, DateTimeKind.Utc).AddTicks(752),
                            ...
                            PreferredName = "Demo",
                            Status = 1,
                            UpdatedAt = new DateTime(2026, 2, 21, 20, 28, 8, 374, DateTimeKind.Utc).AddTicks(753),
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.Organization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 2, 21, 20, 28, 7, 828, DateTimeKind.Utc).AddTicks(5734),
                            Currency = "USD",
                            ...
                            Subdomain = "demo-shop",
                            TaxRate = 0.0000m,
                            UpdatedAt = new DateTime(2026, 2, 21, 20, 28, 7, 828, DateTimeKind.Utc).AddTicks(5734),
                            VerticalType = 1,
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2026, 2, 21, 20, 28, 8, 374, DateTimeKind.Utc).AddTicks(433),
                            Email = "admin@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$RQyy6RL9J489/Isgx7elFu.hHhUy7ExCfNQFJHyofvK/GbiucOVw6",
                            Role = 1,
                            UpdatedAt = new DateTime(2026, 2, 21, 20, 28, 8, 374, DateTimeKind.Utc).AddTicks(465)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2026, 2, 21, 20, 28, 8, 374, DateTimeKind.Utc).AddTicks(511),
                            Email = "owner1@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$RQyy6RL9J489/Isgx7elFu.hHhUy7ExCfNQFJHyofvK/GbiucOVw6",
                            Role = 1,
                            UpdatedAt = new DateTime(2026, 2, 21, 20, 28, 8, 374, DateTimeKind.Utc).AddTicks(512)
                        },
                        new
                        {
                            Id = new Guid("44444444-4444-4444-4444-444444444444"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2026, 2, 21, 20, 28, 8, 374, DateTimeKind.Utc).AddTicks(542),
                            Email = "consignor1@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$RQyy6RL9J489/Isgx7elFu.hHhUy7ExCfNQFJHyofvK/GbiucOVw6",
                            Role = 2,
                            UpdatedAt = new DateTime(2026, 2, 21, 20, 28, 8, 374, DateTimeKind.Utc).AddTicks(542)
                        },
                        new
                        {
                            Id = new Guid("55555555-5555-5555-5555-555555555555"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2026, 2, 21, 20, 28, 8, 374, DateTimeKind.Utc).AddTicks(558),
                            Email = "customer1@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$RQyy6RL9J489/Isgx7elFu.hHhUy7ExCfNQFJHyofvK/GbiucOVw6",
                            Role = 3,
                            UpdatedAt = new DateTime(2026, 2, 21, 20, 28, 8, 374, DateTimeKind.Utc).AddTicks(559)
                        });
                });
