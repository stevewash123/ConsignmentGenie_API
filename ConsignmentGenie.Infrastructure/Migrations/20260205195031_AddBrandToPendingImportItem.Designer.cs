...
namespace ConsignmentGenie.Infrastructure.Migrations
{
    ...
    [Migration("20260205195031_AddBrandToPendingImportItem")]
    partial class AddBrandToPendingImportItem
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.Consignor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 2, 5, 19, 50, 29, 940, DateTimeKind.Utc).AddTicks(2019),
                            ...
                            PortalAccess = false,
                            Status = 1,
                            UpdatedAt = new DateTime(2026, 2, 5, 19, 50, 29, 940, DateTimeKind.Utc).AddTicks(2020),
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.Organization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 2, 5, 19, 50, 29, 393, DateTimeKind.Utc).AddTicks(6155),
                            Currency = "USD",
                            ...
                            Subdomain = "demo-shop",
                            TaxRate = 0.0000m,
                            UpdatedAt = new DateTime(2026, 2, 5, 19, 50, 29, 393, DateTimeKind.Utc).AddTicks(6156),
                            VerticalType = 1,
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2026, 2, 5, 19, 50, 29, 940, DateTimeKind.Utc).AddTicks(1732),
                            Email = "admin@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$DdAPNYL7lOTNa8o6fgVehu1iaPosf0apTtK8XGIF7mKuqDbMzk322",
                            Role = 1,
                            UpdatedAt = new DateTime(2026, 2, 5, 19, 50, 29, 940, DateTimeKind.Utc).AddTicks(1770)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2026, 2, 5, 19, 50, 29, 940, DateTimeKind.Utc).AddTicks(1802),
                            Email = "owner1@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$DdAPNYL7lOTNa8o6fgVehu1iaPosf0apTtK8XGIF7mKuqDbMzk322",
                            Role = 1,
                            UpdatedAt = new DateTime(2026, 2, 5, 19, 50, 29, 940, DateTimeKind.Utc).AddTicks(1803)
                        },
                        new
                        {
                            Id = new Guid("44444444-4444-4444-4444-444444444444"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2026, 2, 5, 19, 50, 29, 940, DateTimeKind.Utc).AddTicks(1817),
                            Email = "consignor1@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$DdAPNYL7lOTNa8o6fgVehu1iaPosf0apTtK8XGIF7mKuqDbMzk322",
                            Role = 2,
                            UpdatedAt = new DateTime(2026, 2, 5, 19, 50, 29, 940, DateTimeKind.Utc).AddTicks(1818)
                        },
                        new
                        {
                            Id = new Guid("55555555-5555-5555-5555-555555555555"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2026, 2, 5, 19, 50, 29, 940, DateTimeKind.Utc).AddTicks(1832),
                            Email = "customer1@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$DdAPNYL7lOTNa8o6fgVehu1iaPosf0apTtK8XGIF7mKuqDbMzk322",
                            Role = 3,
                            UpdatedAt = new DateTime(2026, 2, 5, 19, 50, 29, 940, DateTimeKind.Utc).AddTicks(1833)
                        });
                });
