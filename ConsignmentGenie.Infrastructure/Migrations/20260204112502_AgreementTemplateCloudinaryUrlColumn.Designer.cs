...
namespace ConsignmentGenie.Infrastructure.Migrations
{
    ...
    [Migration("20260204112502_AgreementTemplateCloudinaryUrlColumn")]
    partial class AgreementTemplateCloudinaryUrlColumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.Consignor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 2, 4, 11, 25, 0, 213, DateTimeKind.Utc).AddTicks(4993),
                            ...
                            PortalAccess = false,
                            Status = 1,
                            UpdatedAt = new DateTime(2026, 2, 4, 11, 25, 0, 213, DateTimeKind.Utc).AddTicks(4993),
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.Organization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 2, 4, 11, 24, 59, 649, DateTimeKind.Utc).AddTicks(9194),
                            Currency = "USD",
                            ...
                            Subdomain = "demo-shop",
                            TaxRate = 0.0000m,
                            UpdatedAt = new DateTime(2026, 2, 4, 11, 24, 59, 649, DateTimeKind.Utc).AddTicks(9195),
                            VerticalType = 1,
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2026, 2, 4, 11, 25, 0, 213, DateTimeKind.Utc).AddTicks(4705),
                            Email = "admin@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$g1vqQ0qa/moV9N3nDRAEYefrOjAyH3qInztaPkVfRXSFlpq.heq7a",
                            Role = 1,
                            UpdatedAt = new DateTime(2026, 2, 4, 11, 25, 0, 213, DateTimeKind.Utc).AddTicks(4751)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2026, 2, 4, 11, 25, 0, 213, DateTimeKind.Utc).AddTicks(4778),
                            Email = "owner1@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$g1vqQ0qa/moV9N3nDRAEYefrOjAyH3qInztaPkVfRXSFlpq.heq7a",
                            Role = 1,
                            UpdatedAt = new DateTime(2026, 2, 4, 11, 25, 0, 213, DateTimeKind.Utc).AddTicks(4779)
                        },
                        new
                        {
                            Id = new Guid("44444444-4444-4444-4444-444444444444"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2026, 2, 4, 11, 25, 0, 213, DateTimeKind.Utc).AddTicks(4797),
                            Email = "consignor1@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$g1vqQ0qa/moV9N3nDRAEYefrOjAyH3qInztaPkVfRXSFlpq.heq7a",
                            Role = 2,
                            UpdatedAt = new DateTime(2026, 2, 4, 11, 25, 0, 213, DateTimeKind.Utc).AddTicks(4797)
                        },
                        new
                        {
                            Id = new Guid("55555555-5555-5555-5555-555555555555"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2026, 2, 4, 11, 25, 0, 213, DateTimeKind.Utc).AddTicks(4814),
                            Email = "customer1@microsaasbuilders.com",
                            IsActive = true,
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$g1vqQ0qa/moV9N3nDRAEYefrOjAyH3qInztaPkVfRXSFlpq.heq7a",
                            Role = 3,
                            UpdatedAt = new DateTime(2026, 2, 4, 11, 25, 0, 213, DateTimeKind.Utc).AddTicks(4814)
                        });
                });
