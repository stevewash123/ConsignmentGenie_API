...
{
    /// <inheritdoc />
    public partial class InitialMigrationWithSetupWizard : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoreSlug = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("22222222-2222-2222-2222-222222222222"), 1, null, null, new DateTime(2025, 11, 22, 21, 35, 46, 937, DateTimeKind.Utc).AddTicks(8248), "admin@demoshop.com", null, new Guid("11111111-1111-1111-1111-111111111111"), "$2a$11$J/fWyoF3Q8uNAiSowvrGpuHpO9iOTu7wyDElp/UvjAJv1DGof4e2K", null, null, 1, new DateTime(2025, 11, 22, 21, 35, 46, 937, DateTimeKind.Utc).AddTicks(8249) },
                    { new Guid("33333333-3333-3333-3333-333333333333"), 1, null, null, new DateTime(2025, 11, 22, 21, 35, 46, 937, DateTimeKind.Utc).AddTicks(8273), "owner@demoshop.com", null, new Guid("11111111-1111-1111-1111-111111111111"), "$2a$11$J/fWyoF3Q8uNAiSowvrGpuHpO9iOTu7wyDElp/UvjAJv1DGof4e2K", null, null, 2, new DateTime(2025, 11, 22, 21, 35, 46, 937, DateTimeKind.Utc).AddTicks(8274) },
                    { new Guid("44444444-4444-4444-4444-444444444444"), 1, null, null, new DateTime(2025, 11, 22, 21, 35, 46, 937, DateTimeKind.Utc).AddTicks(8288), "provider@demoshop.com", null, new Guid("11111111-1111-1111-1111-111111111111"), "$2a$11$J/fWyoF3Q8uNAiSowvrGpuHpO9iOTu7wyDElp/UvjAJv1DGof4e2K", null, null, 6, new DateTime(2025, 11, 22, 21, 35, 46, 937, DateTimeKind.Utc).AddTicks(8289) },
                    { new Guid("55555555-5555-5555-5555-555555555555"), 1, null, null, new DateTime(2025, 11, 22, 21, 35, 46, 937, DateTimeKind.Utc).AddTicks(8304), "customer@demoshop.com", null, new Guid("11111111-1111-1111-1111-111111111111"), "$2a$11$J/fWyoF3Q8uNAiSowvrGpuHpO9iOTu7wyDElp/UvjAJv1DGof4e2K", null, null, 7, new DateTime(2025, 11, 22, 21, 35, 46, 937, DateTimeKind.Utc).AddTicks(8304) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("66666666-6666-6666-6666-666666666666"), null, null, null, null, null, null, null, null, 0.6000m, null, null, new DateTime(2025, 11, 22, 21, 35, 46, 937, DateTimeKind.Utc).AddTicks(8545), null, null, null, "provider@demoshop.com", "Demo", null, null, "Artist", null, new Guid("11111111-1111-1111-1111-111111111111"), null, null, "(555) 123-4567", false, null, null, "PRV-00001", null, null, 1, null, null, new DateTime(2025, 11, 22, 21, 35, 46, 937, DateTimeKind.Utc).AddTicks(8546), null, new Guid("44444444-4444-4444-4444-444444444444"), null });
