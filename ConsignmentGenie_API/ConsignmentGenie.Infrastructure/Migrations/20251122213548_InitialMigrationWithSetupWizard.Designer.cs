...
namespace ConsignmentGenie.Infrastructure.Migrations
{
    ...
    [Migration("20251122213548_InitialMigrationWithSetupWizard")]
    partial class InitialMigrationWithSetupWizard
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.Organization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 22, 21, 35, 46, 370, DateTimeKind.Utc).AddTicks(4150),
                            Currency = "USD",
                            ...
                            UpdatedAt = new DateTime(2025, 11, 22, 21, 35, 46, 370, DateTimeKind.Utc).AddTicks(4151),
                            VerticalType = 1
                        });
                });
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.Provider", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 22, 21, 35, 46, 937, DateTimeKind.Utc).AddTicks(8545),
                            ...
                            Status = 1,
                            UpdatedAt = new DateTime(2025, 11, 22, 21, 35, 46, 937, DateTimeKind.Utc).AddTicks(8546),
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2025, 11, 22, 21, 35, 46, 937, DateTimeKind.Utc).AddTicks(8248),
                            Email = "admin@demoshop.com",
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$J/fWyoF3Q8uNAiSowvrGpuHpO9iOTu7wyDElp/UvjAJv1DGof4e2K",
                            Role = 1,
                            UpdatedAt = new DateTime(2025, 11, 22, 21, 35, 46, 937, DateTimeKind.Utc).AddTicks(8249)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2025, 11, 22, 21, 35, 46, 937, DateTimeKind.Utc).AddTicks(8273),
                            Email = "owner@demoshop.com",
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$J/fWyoF3Q8uNAiSowvrGpuHpO9iOTu7wyDElp/UvjAJv1DGof4e2K",
                            Role = 2,
                            UpdatedAt = new DateTime(2025, 11, 22, 21, 35, 46, 937, DateTimeKind.Utc).AddTicks(8274)
                        },
                        new
                        {
                            Id = new Guid("44444444-4444-4444-4444-444444444444"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2025, 11, 22, 21, 35, 46, 937, DateTimeKind.Utc).AddTicks(8288),
                            Email = "provider@demoshop.com",
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$J/fWyoF3Q8uNAiSowvrGpuHpO9iOTu7wyDElp/UvjAJv1DGof4e2K",
                            Role = 6,
                            UpdatedAt = new DateTime(2025, 11, 22, 21, 35, 46, 937, DateTimeKind.Utc).AddTicks(8289)
                        },
                        new
                        {
                            Id = new Guid("55555555-5555-5555-5555-555555555555"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2025, 11, 22, 21, 35, 46, 937, DateTimeKind.Utc).AddTicks(8304),
                            Email = "customer@demoshop.com",
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$J/fWyoF3Q8uNAiSowvrGpuHpO9iOTu7wyDElp/UvjAJv1DGof4e2K",
                            Role = 7,
                            UpdatedAt = new DateTime(2025, 11, 22, 21, 35, 46, 937, DateTimeKind.Utc).AddTicks(8304)
                        });
                });
