...
namespace ConsignmentGenie.Infrastructure.Migrations
{
    ...
    [Migration("20251122105146_PayoutSystemImplementation")]
    partial class PayoutSystemImplementation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.Organization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 22, 10, 51, 45, 56, DateTimeKind.Utc).AddTicks(4696),
                            ...
                            SubscriptionTier = 2,
                            UpdatedAt = new DateTime(2025, 11, 22, 10, 51, 45, 56, DateTimeKind.Utc).AddTicks(4698),
                            VerticalType = 1
                        });
                });
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.Provider", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 22, 10, 51, 45, 262, DateTimeKind.Utc).AddTicks(8498),
                            ...
                            PortalAccess = false,
                            Status = 1,
                            UpdatedAt = new DateTime(2025, 11, 22, 10, 51, 45, 262, DateTimeKind.Utc).AddTicks(8499),
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 22, 10, 51, 45, 262, DateTimeKind.Utc).AddTicks(8190),
                            Email = "admin@demoshop.com",
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$DtUnvMdlCUrZseSPU/h2N.GV2O15D.DWcf1UziXd6R/5yVS96.D9K",
                            Role = 1,
                            UpdatedAt = new DateTime(2025, 11, 22, 10, 51, 45, 262, DateTimeKind.Utc).AddTicks(8215)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2025, 11, 22, 10, 51, 45, 262, DateTimeKind.Utc).AddTicks(8243),
                            Email = "owner@demoshop.com",
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$DtUnvMdlCUrZseSPU/h2N.GV2O15D.DWcf1UziXd6R/5yVS96.D9K",
                            Role = 2,
                            UpdatedAt = new DateTime(2025, 11, 22, 10, 51, 45, 262, DateTimeKind.Utc).AddTicks(8244)
                        },
                        new
                        {
                            Id = new Guid("44444444-4444-4444-4444-444444444444"),
                            CreatedAt = new DateTime(2025, 11, 22, 10, 51, 45, 262, DateTimeKind.Utc).AddTicks(8259),
                            Email = "provider@demoshop.com",
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$DtUnvMdlCUrZseSPU/h2N.GV2O15D.DWcf1UziXd6R/5yVS96.D9K",
                            Role = 6,
                            UpdatedAt = new DateTime(2025, 11, 22, 10, 51, 45, 262, DateTimeKind.Utc).AddTicks(8260)
                        },
                        new
                        {
                            Id = new Guid("55555555-5555-5555-5555-555555555555"),
                            CreatedAt = new DateTime(2025, 11, 22, 10, 51, 45, 262, DateTimeKind.Utc).AddTicks(8276),
                            Email = "customer@demoshop.com",
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$DtUnvMdlCUrZseSPU/h2N.GV2O15D.DWcf1UziXd6R/5yVS96.D9K",
                            Role = 7,
                            UpdatedAt = new DateTime(2025, 11, 22, 10, 51, 45, 262, DateTimeKind.Utc).AddTicks(8276)
                        });
                });
