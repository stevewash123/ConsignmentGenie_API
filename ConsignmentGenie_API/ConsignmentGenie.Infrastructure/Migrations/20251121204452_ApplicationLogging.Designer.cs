...
namespace ConsignmentGenie.Infrastructure.Migrations
{
    ...
    [Migration("20251121204452_ApplicationLogging")]
    partial class ApplicationLogging
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.ApplicationLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.Organization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 21, 20, 44, 51, 446, DateTimeKind.Utc).AddTicks(3773),
                            ...
                            SubscriptionTier = 2,
                            UpdatedAt = new DateTime(2025, 11, 21, 20, 44, 51, 446, DateTimeKind.Utc).AddTicks(3774),
                            VerticalType = 1
                        });
                });
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.Provider", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 21, 20, 44, 51, 652, DateTimeKind.Utc).AddTicks(3145),
                            ...
                            PortalAccess = false,
                            Status = 1,
                            UpdatedAt = new DateTime(2025, 11, 21, 20, 44, 51, 652, DateTimeKind.Utc).AddTicks(3145),
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 21, 20, 44, 51, 652, DateTimeKind.Utc).AddTicks(2530),
                            Email = "admin@demoshop.com",
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$vNEPq3UEKNgBYyewNN.UAetPTEb9UT6blRC0ExixR1uBNzz0tstmG",
                            Role = 1,
                            UpdatedAt = new DateTime(2025, 11, 21, 20, 44, 51, 652, DateTimeKind.Utc).AddTicks(2531)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2025, 11, 21, 20, 44, 51, 652, DateTimeKind.Utc).AddTicks(2559),
                            Email = "owner@demoshop.com",
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$vNEPq3UEKNgBYyewNN.UAetPTEb9UT6blRC0ExixR1uBNzz0tstmG",
                            Role = 2,
                            UpdatedAt = new DateTime(2025, 11, 21, 20, 44, 51, 652, DateTimeKind.Utc).AddTicks(2559)
                        },
                        new
                        {
                            Id = new Guid("44444444-4444-4444-4444-444444444444"),
                            CreatedAt = new DateTime(2025, 11, 21, 20, 44, 51, 652, DateTimeKind.Utc).AddTicks(2572),
                            Email = "provider@demoshop.com",
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$vNEPq3UEKNgBYyewNN.UAetPTEb9UT6blRC0ExixR1uBNzz0tstmG",
                            Role = 6,
                            UpdatedAt = new DateTime(2025, 11, 21, 20, 44, 51, 652, DateTimeKind.Utc).AddTicks(2593)
                        },
                        new
                        {
                            Id = new Guid("55555555-5555-5555-5555-555555555555"),
                            CreatedAt = new DateTime(2025, 11, 21, 20, 44, 51, 652, DateTimeKind.Utc).AddTicks(2805),
                            Email = "customer@demoshop.com",
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$vNEPq3UEKNgBYyewNN.UAetPTEb9UT6blRC0ExixR1uBNzz0tstmG",
                            Role = 7,
                            UpdatedAt = new DateTime(2025, 11, 21, 20, 44, 51, 652, DateTimeKind.Utc).AddTicks(2806)
                        });
                });
