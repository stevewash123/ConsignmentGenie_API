...
namespace ConsignmentGenie.Infrastructure.Migrations
{
    ...
    [Migration("20251122131948_RegistrationAndApprovalFlow")]
    partial class RegistrationAndApprovalFlow
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.Organization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 22, 13, 19, 46, 788, DateTimeKind.Utc).AddTicks(3081),
                            ...
                            SubscriptionTier = 2,
                            UpdatedAt = new DateTime(2025, 11, 22, 13, 19, 46, 788, DateTimeKind.Utc).AddTicks(3082),
                            VerticalType = 1
                        });
                });
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.Provider", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 22, 13, 19, 47, 3, DateTimeKind.Utc).AddTicks(8963),
                            ...
                            PortalAccess = false,
                            Status = 1,
                            UpdatedAt = new DateTime(2025, 11, 22, 13, 19, 47, 3, DateTimeKind.Utc).AddTicks(8963),
            ...
            modelBuilder.Entity("ConsignmentGenie.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2025, 11, 22, 13, 19, 47, 3, DateTimeKind.Utc).AddTicks(8657),
                            Email = "admin@demoshop.com",
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$CGLc9CD5/XAJqp1eCd67yelz9daNNKGQM9maAEEHIJVek/bBfTqGi",
                            Role = 1,
                            UpdatedAt = new DateTime(2025, 11, 22, 13, 19, 47, 3, DateTimeKind.Utc).AddTicks(8666)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2025, 11, 22, 13, 19, 47, 3, DateTimeKind.Utc).AddTicks(8693),
                            Email = "owner@demoshop.com",
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$CGLc9CD5/XAJqp1eCd67yelz9daNNKGQM9maAEEHIJVek/bBfTqGi",
                            Role = 2,
                            UpdatedAt = new DateTime(2025, 11, 22, 13, 19, 47, 3, DateTimeKind.Utc).AddTicks(8693)
                        },
                        new
                        {
                            Id = new Guid("44444444-4444-4444-4444-444444444444"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2025, 11, 22, 13, 19, 47, 3, DateTimeKind.Utc).AddTicks(8710),
                            Email = "provider@demoshop.com",
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$CGLc9CD5/XAJqp1eCd67yelz9daNNKGQM9maAEEHIJVek/bBfTqGi",
                            Role = 6,
                            UpdatedAt = new DateTime(2025, 11, 22, 13, 19, 47, 3, DateTimeKind.Utc).AddTicks(8711)
                        },
                        new
                        {
                            Id = new Guid("55555555-5555-5555-5555-555555555555"),
                            ApprovalStatus = 1,
                            CreatedAt = new DateTime(2025, 11, 22, 13, 19, 47, 3, DateTimeKind.Utc).AddTicks(8726),
                            Email = "customer@demoshop.com",
                            OrganizationId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "$2a$11$CGLc9CD5/XAJqp1eCd67yelz9daNNKGQM9maAEEHIJVek/bBfTqGi",
                            Role = 7,
                            UpdatedAt = new DateTime(2025, 11, 22, 13, 19, 47, 3, DateTimeKind.Utc).AddTicks(8727)
                        });
                });
