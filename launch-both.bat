...
start "ConsignmentGenie API" cmd /k "cd ConsignmentGenie_API\ConsignmentGenie.API && echo Building API... && dotnet build && if %ERRORLEVEL% equ 0 (echo Starting API server... && dotnet run) else (echo API build failed! && pause)"
