...
public class StoreServiceTests : IDisposable
{
    ...
    private async Task SeedTestData()
    {
        ...
        // Create categories
        var electronicsCategory = new ItemCategory
        {
            Id = Guid.NewGuid(),
        ...
        var clothingCategory = new ItemCategory
        {
            Id = Guid.NewGuid(),
            OrganizationId = _organizationId,
            Name = "Clothing",
        ...
        var items = new List<Item>
        {
            ...
            new Item
            {
                Id = Guid.NewGuid(),
                OrganizationId = _organizationId,
                ItemCategoryId = clothingCategory.Id,
                Title = "Test Item 2",
        ...
        _context.ItemCategories.AddRange(electronicsCategory, clothingCategory);
    ...
    public async Task GetItemsAsync_CategoryFilter_ReturnsFilteredItems()
    {
        ...
        // Assert
        Assert.Equal(1, totalCount); // One item is assigned to Electronics category
        Assert.Single(items);
        Assert.Equal("Test Item 1", items[0].Title);
    }
