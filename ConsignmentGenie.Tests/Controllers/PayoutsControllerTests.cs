...
namespace ConsignmentGenie.Tests.Controllers
{
    public class PayoutsControllerTests : IDisposable
    {
        ...
        public PayoutsControllerTests()
        {
            ...
            var mockLogger = new Mock<ILogger<PayoutsController>>();
            var mockNotificationService = new Mock<IConsignorNotificationService>();
            _controller = new PayoutsController(_context, mockLogger.Object, mockNotificationService.Object);
        ...
        private async Task SeedTestData()
        {
            ...
            // Add transactions with transaction items
            ...
            var transactionItem1 = new TransactionItem
            {
                Id = Guid.NewGuid(),
                ...
                Quantity = 1,
                UnitPrice = 100.00m,
                ConsignorSplitPercentage = 0.6m,
                ConsignorAmount = 60.00m,
                StoreAmount = 40.00m,
                CreatedAt = DateTime.UtcNow
            };
            transaction1.Items.Add(transactionItem1);
            ...
            var transactionItem2 = new TransactionItem
            {
                Id = Guid.NewGuid(),
            ...
            transaction2.Items.Add(transactionItem2);

            _context.Transactions.AddRange(transaction1, transaction2);
            _context.TransactionItems.AddRange(transactionItem1, transactionItem2);
