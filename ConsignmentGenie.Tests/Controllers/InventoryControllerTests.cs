...
namespace ConsignmentGenie.Tests.Controllers
{
    public class InventoryControllerTests
    {
        ...
        private readonly Mock<PendingImportAssignmentService> _mockAssignmentService;
        ...
        {
            _mockAssignmentService = new Mock<PendingImportAssignmentService>(Mock.Of<IUnitOfWork>(), Mock.Of<ILogger<PendingImportAssignmentService>>());
            _mockUnitOfWork = new Mock<IUnitOfWork>();
            _controller = new InventoryController(_mockAssignmentService.Object, _mockUnitOfWork.Object);
        ...
        {
            // Arrange & Act
            var mockAssignmentService = new Mock<PendingImportAssignmentService>(Mock.Of<IUnitOfWork>(), Mock.Of<ILogger<PendingImportAssignmentService>>());
            var mockUnitOfWork = new Mock<IUnitOfWork>();
            var controller = new InventoryController(mockAssignmentService.Object, mockUnitOfWork.Object);
