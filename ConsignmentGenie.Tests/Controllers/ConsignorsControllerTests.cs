...
namespace ConsignmentGenie.Tests.Controllers
{
    ...
    public class ConsignorsControllerTests : IDisposable
    {
        ...
        public ConsignorsControllerTests()
        {
            ...
            _controller = new ConsignorsController(_context, _mockLogger.Object, _mockInvitationService.Object, _mockEmailService.Object);
        ...
        {
            // Arrange & Act
            var controller = new ConsignorsController(_context, _mockLogger.Object, _mockInvitationService.Object, _mockEmailService.Object);
        ...
        {
            // Arrange
            _mockEmailService.Setup(x => x.SendConsignorWelcomeAsync(
                It.IsAny<string>(),
                It.IsAny<string>(),
                It.IsAny<string>(),
                It.IsAny<string>(),
