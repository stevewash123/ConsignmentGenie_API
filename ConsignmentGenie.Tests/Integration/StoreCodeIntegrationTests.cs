...
namespace ConsignmentGenie.Tests.Integration
{
    public class StoreCodeIntegrationTests : IDisposable
    {
        ...
        public StoreCodeIntegrationTests()
        {
            ...
            var mockUnifiedNotificationService = new Mock<INotificationService>();
            ...
            _registrationService = new RegistrationService(
                ...
                mockUnifiedNotificationService.Object,
        ...
        public async Task EndToEndRegistration_WithStoreCodeGeneration_CreatesValidStoreCode()
        {
            ...
            var request = new RegisterOwnerRequest
            {
                ...
                StreetAddress = "123 Integration St",
            ...
            var organization = await _context.Organizations
                .FirstOrDefaultAsync(o => o.Name == request.ShopName);
        ...
        public async Task StoreCodeRegeneration_UpdatesCodeAndTimestamp()
        {
            ...
            var organization = await _context.Organizations
                .FirstOrDefaultAsync(o => o.Name == registerRequest.ShopName);
            Assert.NotNull(organization);
        ...
        public async Task StoreCodeValidation_WithConsignorRegistration_WorksCorrectly()
        {
            ...
            var organization = await _context.Organizations
                .FirstOrDefaultAsync(o => o.Name == ownerRequest.ShopName);
            Assert.NotNull(organization);
