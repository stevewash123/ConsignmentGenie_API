        ...
        try
        {
            ...
            if (inviterOrganization != Guid.Empty)
            {
                await _notificationService.CreateNotificationAsync(new CreateNotificationRequest
                {
                    ...
                    FromType = "owner",
                    ToUserId = invitedById, // Notification to the inviter
                    ToType = "owner",
                    Type = NotificationType.OwnerInvitationSent.ToString(),
        ...
        try
        {
            ...
            try
            {
                ...
                await _notificationService.CreateNotificationAsync(new CreateNotificationRequest
                {
                    ...
                    ToUserId = user.Id,
                    ToType = "owner",
                    Type = NotificationType.WelcomeEmail.ToString(),
