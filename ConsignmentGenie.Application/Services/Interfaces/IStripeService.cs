...
public interface IStripeService
{
    ...
    Task<IntegrationPricingResult> GetIntegrationPricingAsync(Guid organizationId, string integration);
}
...
public class IntegrationPricingResult
{
    public bool Success { get; set; }
    public string? ErrorMessage { get; set; }
    ...
    public long MonthlyAmount { get; set; }  // Amount in cents
