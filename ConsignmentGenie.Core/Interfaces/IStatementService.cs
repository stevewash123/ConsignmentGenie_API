...
{
    /// <summary>
    /// Generates a statement for a consignor for a specific period
    /// </summary>
    Task<StatementDto> GenerateStatementAsync(Guid consignorId, DateOnly periodStart, DateOnly periodEnd);

    /// <summary>
    /// Generates statements for all consignors for a specific month
    /// </summary>
    Task GenerateStatementsForMonthAsync(int year, int month);

    /// <summary>
    /// Gets all statements for a consignor
    /// </summary>
