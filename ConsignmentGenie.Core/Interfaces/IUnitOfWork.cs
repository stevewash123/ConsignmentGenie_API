...
public interface IUnitOfWork : IDisposable
{
    ...
    IRepository<ConsignorAgreement> ConsignorAgreements { get; }
    ...
    IRepository<PendingSquareImport> PendingSquareImports { get; }
    IRepository<PendingSquareTransaction> PendingSquareTransactions { get; }
    IRepository<PendingSquareTransactionItem> PendingSquareTransactionItems { get; }
    ...
    IRepository<DropoffRequest> DropoffRequests { get; }
