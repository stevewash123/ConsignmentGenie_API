...
public interface IRegistrationService
{
    ...
    Task<RegistrationResultDto> RegisterConsignorAsync(RegisterConsignorRequest request);
    Task<List<PendingApprovalDto>> GetPendingConsignorsAsync(Guid organizationId);
    ...
    Task<RegistrationResultDto> RegisterConsignorFromInvitationAsync(RegisterConsignorFromInvitationRequest request);
}