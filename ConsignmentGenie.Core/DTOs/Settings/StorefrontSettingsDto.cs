...
public class SquareSettingsDto
{
    ...
    public bool ImportSales { get; set; } = false;
...
public class CgStorefrontSettingsDto
{
    ...
    // Complex settings for auto-save support
    public StorefrontPaymentSettingsDto PaymentSettings { get; set; } = new();
    public StorefrontShippingSettingsDto ShippingSettings { get; set; } = new();
    public StorefrontSalesSettingsDto SalesSettings { get; set; } = new();
}

public class StorefrontPaymentSettingsDto
{
    public bool EnableCreditCards { get; set; } = true;
    public bool EnableBuyNow { get; set; } = true;
    public bool EnableLayaway { get; set; } = false;
    public int LayawayDepositPercentage { get; set; } = 25;
    public int LayawayTermsInDays { get; set; } = 30;
}

public class StorefrontShippingSettingsDto
{
    public bool EnableShipping { get; set; } = false;
    public decimal FlatRate { get; set; } = 0;
    public decimal FreeShippingThreshold { get; set; } = 0;
    public string ShipsFromZipCode { get; set; } = "";
}

public class StorefrontSalesSettingsDto
{
    public bool EnableBestOffer { get; set; } = false;
    public int AutoAcceptPercentage { get; set; } = 0;
    public int MinimumOfferPercentage { get; set; } = 0;
}
