...
public class Item : BaseEntity
{
    ...
    public Guid? ItemCategoryId { get; set; } // Category reference (ItemCategories table)
    ...
    public DateTime? SquareLastSyncAt { get; set; }

    public bool IsSquareManaged { get; set; } = false;
    ...
    public ItemCategory? ItemCategoryNavigation { get; set; }
